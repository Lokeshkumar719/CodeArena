# `frontend/src/components/admin/ManageVideoSolutions.jsx`

**Source:** `frontend/src/components/admin/ManageVideoSolutions.jsx`  
**Doc path:** `frontend_docs/components/admin/ManageVideoSolutions.md`
...
- Same list/pagination pattern as UpdateProblemList.
...
| Symbol | Type | Role |
|--------|------|------|
| `ManageVideoSolutions` | default export | List UI |
| `fetchProblems` | async | GET paginated problems |

# Internal Logic

Identical structure to UpdateProblemList except action button label/route (`/admin/upload/${problem._id}`).
