# `frontend/src/components/admin/UpdateProblemList.jsx`

**Source:** `frontend/src/components/admin/UpdateProblemList.jsx`  
**Doc path:** `frontend_docs/components/admin/UpdateProblemList.md`
...
| Symbol | Type | Role |
|--------|------|------|
| `UpdateProblemList` | default export | List UI |
