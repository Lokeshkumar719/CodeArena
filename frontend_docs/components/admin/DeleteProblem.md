# `frontend/src/components/admin/DeleteProblem.jsx`

**Source:** `frontend/src/components/admin/DeleteProblem.jsx`  
**Doc path:** `frontend_docs/components/admin/DeleteProblem.md`
...
| Symbol | Type | Role |
|--------|------|------|
| `DeleteProblem` | default export | Delete UI |
