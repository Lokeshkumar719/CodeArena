            ...
            <tbody>
              {Array.from({ length: rows }).map((_, i) => (
                <tr key={i} style={{ borderBottom: i < rows - 1 ? '1px solid #1e2738' : 'none' }}>
                  ...
                  <td style={{ padding: '16px 20px', verticalAlign: 'middle' }}>
                    <div
                      style={{ ...shimmer, height: '24px', width: '64px', borderRadius: '999px' }}
                    />
                  </td>
                  ...
                  <td style={{ padding: '16px 20px', verticalAlign: 'middle' }}>
                    <div style={{ display: 'flex', gap: '6px' }}>
                      <div
                        style={{ ...shimmer, height: '22px', width: '60px', borderRadius: '999px' }}
                      />
                      <div
                        style={{ ...shimmer, height: '22px', width: '72px', borderRadius: '999px' }}
                      />
                    </div>
                  </td>
                  ...
                  <td style={{ padding: '16px 20px', verticalAlign: 'middle' }}>
                    <div style={{ display: 'flex', gap: '10px' }}>
                      <div
                        style={{ ...shimmer, height: '34px', width: '120px', borderRadius: '8px' }}
                      />
                      <div
                        style={{ ...shimmer, height: '34px', width: '120px', borderRadius: '8px' }}
                      />
