    ...
    <div>
      ...
      {problem.inputFormat && (
        <div className="mt-6">
          ...
          <div className="example-card font-mono whitespace-pre-wrap">{problem.inputFormat}</div>
        </div>
      )}
      ...
      {problem.outputFormat && (
        <div className="mt-6">
          ...
          <div className="example-card font-mono whitespace-pre-wrap">{problem.outputFormat}</div>
        </div>
      )}
      ...
      {problem.constraints && (
        <div className="mt-6">
          ...
          <div className="example-card font-mono whitespace-pre-wrap">{problem.constraints}</div>
        </div>
      )}
      ...
      {problem.visibleTestCases.map((ex, i) => (
        <div key={i} className="example-card">
          ...
          <div className="example-row">
            ...
            <span className="example-val font-mono whitespace-pre-wrap">{ex.input}</span>
          </div>

          <div className="example-row">
            <span className="example-key">Output:</span>
            <span className="example-val font-mono whitespace-pre-wrap">{ex.output}</span>
          </div>

          {ex.explanation && (
            <div className="example-row">
              <span className="example-key">Explanation:</span>
              <span className="example-val whitespace-pre-wrap">{ex.explanation}</span>
            </div>
          )}
        </div>
      ))}
