...
function ResetPassword() {
  ...
  const preventActions=(e,message)=>{
    e.preventDefault();
          ...
          <div style={s.fieldGroup}>
            ...
            <div style={s.passwordWrapper}>
              ...
              <input
                ...
                placeholder="••••••••"
                onPaste={(e)=>preventActions(e,"Paste is not allowed")}
                onCopy={(e)=>preventActions(e,"Copy is not allowed")}
                onCut={(e)=>preventActions(e,"Cut is not allowed")}
                onDragStart={(e)=>preventActions(e)}
                {...register("password")}
                style={{
                  ...s.input,
                  paddingRight:"46px",
