...
| Rate limit middleware | `backend/src/middlewares/rateLimitMiddleware.js` | [rateLimitMiddleware.md](../backend_docs/middleware/rateLimitMiddleware.md) |
| Redis config & client | `backend/src/config/redis.js` | [redis.md](../backend_docs/config/redis.md) |
| Auth services (Refresh) | `backend/src/services/auth/` | [authServices.md](../backend_docs/services/authServices.md) |
| Problem querying | `backend/src/services/problem/listingProblems.js` | [listingProblems.md](../backend_docs/services/problem/listingProblems.md) |
...
| Judge0 batch + base64 | `backend/src/services/judge0Service.js` | [judge0Service.md](../backend_docs/services/judge0Service.md) |
...
| 2 | `backend/src/middlewares/userMiddleware.js` | Auth gate for almost all user APIs — dual JWT logic |
...
| 8 | `backend/src/services/executionService.js` | Orchestrates code execution, limits, and result saving |
...
|---------|----------------|---------------|----------|
| Sign up / login | [Login.md](../frontend_docs/pages/Login.md) | [userAuthenticate.md](../backend_docs/auth/userAuthenticate.md) | [AUTH_FLOW.md](./AUTH_FLOW.md) |
| Password reset | [ForgotPassword.md](../frontend_docs/pages/ForgotPassword.md) | `forgotPassword` in userAuthenticate | [AUTH_FLOW.md](./AUTH_FLOW.md) |
| Problem list/search | [Homepage.md](../frontend_docs/pages/Homepage.md) | [listingProblems.md](../backend_docs/services/problem/listingProblems.md) | [API_FLOW.md](./API_FLOW.md) |
...
**Stack (short):** React 19 + Vite + Redux (auth only) | Express + Mongoose + Redis + Judge0 + Cloudinary + Resend  
...
|------|-------------------|
| Rate limiters fail open if Redis crashes | [rateLimitMiddleware.md](../backend_docs/middleware/rateLimitMiddleware.md) |
| Dual JWT logic: access token expires in 15m | [AUTH_FLOW.md](./AUTH_FLOW.md) |
| Judge0 requires base64 encoded payloads | [judge0Service.md](../backend_docs/services/judge0Service.md) |
| MongoDB text index required on Problem `title` | [DATABASE_FLOW.md](./DATABASE_FLOW.md) |
| `isSolved` flag requires heavy submission lookups | [listingProblems.md](../backend_docs/services/problem/listingProblems.md) |
