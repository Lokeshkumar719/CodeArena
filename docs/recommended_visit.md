...
|------|-------------------|
| Admin routes need `userMiddleware` then `adminMiddleware` | [adminMiddleware.md](../backend_docs/middleware/adminMiddleware.md), [AUTH_FLOW.md](./AUTH_FLOW.md) |
| JWT role in cookie can lag DB role until re-login | [AUTH_FLOW.md](./AUTH_FLOW.md) |
